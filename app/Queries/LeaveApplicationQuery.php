...
trait LeaveApplicationQuery
{
    public static function fetch($request)
    {
        ...
        $leave_application = LeaveApplication::query()
            ...
            ->when($request->date_from, fn($query) => $query->whereDate('leave_applications.date_from', '>=', date("Y-m-d", strtotime($request->date_from))))
            ->when($request->date_to, fn($query) => $query->whereDate('leave_applications.date_to', '<=', date("Y-m-d", strtotime($request->date_to))))
